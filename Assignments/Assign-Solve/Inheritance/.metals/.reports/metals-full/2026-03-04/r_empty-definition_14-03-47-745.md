error id: file:///D:/java_with_Saurabh_shukla/Assignments/Assign-Solve/Inheritance/Person.java:java/io/PrintStream#println(+8).
...
class Employee extends Person{
    ...
    public void input(){
      ...
      //set salary
      System.out.printl@@n("Enter salary:");
